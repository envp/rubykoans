...
class AboutRegularExpressions < Neo::Koan
  def test_a_pattern_is_a_regular_expression
    ...
    # Do not understand.
    # Edit: oh lawd Ruby. OOP is coming slowly to me, why Regexp and not RegExp?
  end
  ...
  #
  # Why?
  # Requesting 0 or more or x [/x*/] returns the [str]longest[/str] first longest substring which is valid match
  # ------------------------------------------------------------------
  ...
  # Do more testing for sub, and gsub
end
