...
class AboutIteration < Neo::Koan
  ...
  def test_collect_transforms_elements_of_an_array
    ...
    # Why so many wrappers for the same method Ruby ?!
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject(VALUE v) {|p, s| #do something}
    # Inject into p the result of the operation described, assuming p has default
    # or initial value v
  end
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    File.open("example_file.txt") do |file|
      ...
      assert_equal "THIS IS A TEST".split(/\s/), upcase_lines
    end
